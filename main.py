...
def main():
    ...
    if args.dataset == 'ucf101':
        ...
        num_class = 400
    elif args.dataset == 'aggression':
        num_class = 2
    else:
        raise ValueError('Unknown dataset '+args.dataset)
    
    if args.modality == 'Pool':
        new_length = 3
    elif args.modality == 'GrayPool':
        new_length = 4
    else:
        new_length = None

    model = TSN(num_class, args.num_segments, args.modality,
                base_model=args.arch, new_length = new_length,
    ...
    # Data loading code
    if args.modality not in ['RGBDiff', 'GrayPool']:
