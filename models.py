...
TSN Configurations:
    ...
    dropout_ratio:      {}
        ...
        elif self.modality in ['RGBDiff', 'Pool']:
            print("Converting the ImageNet model to RGB+Diff init model")
            self.base_model = self._construct_diff_model(self.base_model)
            print("Done. RGBDiff model ready.")
        elif self.modality == 'GrayPool':
            print("Converting the imagenet model to GrayPool init model")
            self.base_model = self._construct_flow_model(self.base_model)
    ...
    def _prepare_base_model(self, base_model):
        ...
        if 'resnet' in base_model or 'vgg' in base_model:
            ...
            if self.modality in ['Flow', 'GrayPool']:
                self.input_mean = [0.5]
    ...
    def forward(self, input):
        ...
        if self.modality in ['RGBDiff', 'Pool']:
    ...
    def get_augmentation(self):
        ...
        elif self.modality in ['Flow', 'GrayPool']:
